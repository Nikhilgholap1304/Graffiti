...
function baseEncode(buffer, base) {
  ...
  const orgDP = Big__default['default'].DP;
  const orgRM = Big__default['default'].RM;
  Big__default['default'].DP = 0;
  Big__default['default'].RM = 0;
  let current = new Big__default['default'](0);
  ...
  Big__default['default'].DP = orgDP;
  Big__default['default'].RM = orgRM;
  return output;
}
...
const readFileAsync = util.promisify(fs.readFile); // replace windows paths to unix paths on windows platform
