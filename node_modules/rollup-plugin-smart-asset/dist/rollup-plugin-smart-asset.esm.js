...
import { isAbsolute, join, dirname, extname, relative, normalize, parse } from 'path';
...
const readFileAsync = promisify(readFile); // replace windows paths to unix paths on windows platform
