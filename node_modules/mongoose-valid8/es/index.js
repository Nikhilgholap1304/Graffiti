...
import { capitalize, startCase, toLower, compact, isEmpty, isFunction, uniqWith, uniq, isString, orderBy } from 'lodash';
...
SchemaString.prototype.capitalize = function capitalize$1(shouldApply) {
  if (arguments.length > 0 && !shouldApply) {
    return this;
  }
  return this.set(function setValue(v /* , self */) {
    const value = capitalize(v);
    return value;
  });
};
...
SchemaArray.prototype.compact = function compact$1(shouldApply) {
  if (arguments.length > 0 && !shouldApply) {
    return this;
  }
  return this.set(function setValue(v /* , self */) {
