...
const InternalMentions = (props, ref) => {
  ...
  }, (0, _statusUtils.getStatusClassNames)(prefixCls, mergedStatus), contextMentions === null || contextMentions === void 0 ? void 0 : contextMentions.className, !hasFeedback && className, rootClassName, hashId, cssVarCls, rootCls);
  const mentions = /*#__PURE__*/React.createElement(_rcMentions.default, Object.assign({
    ...
    classes: {
      affixWrapper: (0, _classnames.default)(hashId, className, cssVarCls, rootCls)
    }
  }), mentionOptions);
